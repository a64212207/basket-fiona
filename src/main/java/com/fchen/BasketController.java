        ...
        for (Person person:retlist){
            ...
            if (person.getChoosetime() !=null) {
                if (person.getChoosetime() == 1) {
                    person.setChoosetimestr("周一、三、五、日 16:30-18:00");
                } else if (person.getChoosetime() == 2) {
                    person.setChoosetimestr("周二、四、六、日 16:30-18:00");
                } else if (person.getChoosetime() == 3) {
                    person.setChoosetimestr("周一、三、五、日 19:00-20:30");
                } else if (person.getChoosetime() == 4) {
                    person.setChoosetimestr("周二、四、六、日 19:00-20:30");
                }
            }
